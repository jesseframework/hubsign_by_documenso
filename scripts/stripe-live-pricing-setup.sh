...
echo "   Enterprise Dedicated now has a priced figure in the pricing doc (\$750/mo + setup)"
echo "   but is sold via a sales conversation, not self-serve checkout — still not created here.)"
