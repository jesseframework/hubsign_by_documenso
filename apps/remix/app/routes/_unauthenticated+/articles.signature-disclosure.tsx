...
const SUPPORT_EMAIL = 'support@hubsign.io';
  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using HubSign to perform your electronic document signing. The purpose of
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by HubSign, you affirm
