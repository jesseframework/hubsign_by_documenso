    ...
    <Card spotlight className={className}>
      <CardContent className="flex flex-col items-center justify-center p-12">
        ...
        <p className="text-muted-foreground mt-4 max-w-[55ch] text-center leading-normal">
          You can get started with HubSign in minutes. We handle the infrastructure, so you can
        ...
        <Button
          ...
          asChild
        >
          <Link href={`https://hubsign.io/signup?utm_source=${utmSource}`} target="_blank">
            Get started
          </Link>
        </Button>
      </CardContent>
