---
title: User Profile
description: Learn how to set up your public profile on HubSign.
---
...
HubSign allows you to create a public profile to share your templates for anyone to sign. This is useful for distributing and collecting signatures for commonly used documents, making it more efficient for both the document creator and the signers.

<Callout type="info">A free HubSign account gives you 5 free signatures per month.</Callout>
...
```bash
https://app.hubsign.io/p/<username>
```
...
The image above shows an example of a public profile on HubSign.
