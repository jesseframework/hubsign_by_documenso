...
The guide assumes you have a HubSign account. If you don't, you can create a free account here.

### Upload Document

Navigate to the [HubSign dashboard](https://app.hubsign.io/documents) and click on the "Add a document" button. Select the document you want to upload and wait for the upload to complete.
...
HubSign enables you to set up access control for your documents. You can require authentication for viewing the document.
...
HubSign has 4 roles for recipients with different permissions and actions.
...
HubSign supports 9 different field types that can be added to the document. Each field type collects various information from the recipients when they sign the document.
...
If you leave the email subject and message empty, HubSign will use the default email template.
...
```bash
https://app.hubsign.io/sign/12ACP777zxQLO52hjj_vCB
```
