...
description: Learn about the different fields you can add to your documents in HubSign.
---

# Document Fields

Learn about the different fields you can add to your documents in HubSign and how to make the most of them.
