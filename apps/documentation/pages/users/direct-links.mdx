...
```bash
https://app.hubsign.io/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [HubSign profile](/users/profile) to make them signable anytime.
