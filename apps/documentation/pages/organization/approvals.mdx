...
- **Settings → Automation → Approval Templates** — define the chains
- **Settings → Automation → Approver Roles & Rules** — name the groups a step can be
  routed to, and the groups a blocked signer may ask for a signing exception
- **Tasks → Approvals** — the queue of decisions waiting on you
